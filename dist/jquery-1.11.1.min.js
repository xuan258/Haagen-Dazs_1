...
!function (e, t) {
  ...
  C.fn = C.prototype = {
    ...
    for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == _typeof(a) || C.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) {
      if (null != (i = arguments[s])) for (r in i) {
        e = a[r], a !== (n = i[r]) && (u && n && (C.isPlainObject(n) || (t = C.isArray(n))) ? (o = t ? (t = !1, e && C.isArray(e) ? e : []) : e && C.isPlainObject(e) ? e : {}, a[r] = C.extend(u, o, n)) : void 0 !== n && (a[r] = n));
      }
    }
    ...
    proxy: function proxy(e, t) {
      var n, r, i;
      return "string" == typeof t && (i = e[t], t = e, e = i), C.isFunction(e) ? (n = c.call(arguments, 2), (r = function r() {
  ...
  var p = function (n) {
    ...
    try {
      _.apply(t = q.call(E.childNodes), E.childNodes), t[E.childNodes.length].nodeType;
    } catch (e) {
      _ = {
    ...
    function re(e, t, n, r) {
      ...
      if ((t ? t.ownerDocument || t : E) !== T && v(t), n = n || [], !e || "string" != typeof e) return n;
      if (1 !== (s = (t = t || T).nodeType) && 9 !== s) return [];

      if (y && !r) {
        if (i = K.exec(e)) if (a = i[1]) {
          if (9 === s) {
          ...
          if ((a = i[3]) && h.getElementsByClassName && t.getElementsByClassName) return _.apply(n, t.getElementsByClassName(a)), n;
        }

        if (h.qsa && (!b || !b.test(e))) {
          if (d = c = N, f = t, p = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
            for (u = m(e), (c = t.getAttribute("id")) ? d = c.replace(ee, "\\$&") : t.setAttribute("id", d), d = "[id='" + d + "'] ", l = u.length; l--;) {
              u[l] = d + he(u[l]);
            }
    ...
    function fe(e) {
      return e && _typeof(e.getElementsByTagName) !== D && e;
    }
    ...
    for (e in h = re.support = {}, r = re.isXML = function (e) {
      ...
      return l !== T && 9 === l.nodeType && l.documentElement ? (i = (T = l).documentElement, y = !r(l), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function () {
        ...
        if (_typeof(t.getElementById) !== D && y) {
        ...
        return function (e) {
          var t = _typeof(e.getAttributeNode) !== D && e.getAttributeNode("id");
          return t && t.value === n;
        };
        ...
        return _typeof(t.getElementsByClassName) !== D && y ? t.getElementsByClassName(e) : void 0;
      }, a = [], b = [], (h.qsa = Q.test(l.querySelectorAll)) && (ae(function (e) {
        e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && b.push("[*^$]=" + F + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || b.push("\\[" + F + "*(?:value|" + O + ")"), e.querySelectorAll(":checked").length || b.push(":checked");
      }), ae(function (e) {
        ...
        return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !h.sortDetached && t.compareDocumentPosition(e) === n ? e === l || e.ownerDocument === E && C(E, e) ? -1 : t === l || t.ownerDocument === E && C(E, t) ? 1 : u ? M.call(u, e) - M.call(u, t) : 0 : 4 & n ? -1 : 1);
      } : function (e, t) {
        if (e === t) return c = !0, 0;
        var n,
            r = 0,
      ...
      var n = x.attrHandle[t.toLowerCase()],
          r = n && j.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !y) : void 0;
      ...
      filter: {
        ...
        CHILD: function CHILD(p, e, t, h, m) {
    ...
    function ye(p, h, m, g, v, e) {
      return g && !g[N] && (g = ye(g)), v && !v[N] && (v = ye(v, e)), oe(function (e, t, n, r) {
        ...
        if (m && m(d, f, n, r), g) for (i = ve(f, l), g(i, [], n, r), o = i.length; o--;) {
          (a = i[o]) && (f[l[o]] = !(d[l[o]] = a));
        }
        ...
        if (e) {
          if (v || p) {
            ...
            for (o = f.length; o--;) {
              (a = f[o]) && -1 < (i = v ? M.call(e, a) : s[o]) && (e[i] = !(t[i] = a));
            }
          }
        } else f = ve(f === t ? f.splice(u, f.length) : f), v ? v(null, t, f, r) : _.apply(t, f);
      });
    }
    ...
    function be(e) {
      for (var r, t, n, i = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, l = me(function (e) {
        ...
        if (t = x.relative[e[s].type]) c = [me(ge(c), t)];else {
    ...
    return pe.prototype = x.filters = x.pseudos, x.setFilters = new pe(), m = re.tokenize = function (e, t) {
      ...
      if (!a) {
        ...
        (a = S(e, (g = o, y = 0 < (v = i).length, b = 0 < g.length, r = function r(e, t, n, _r, i) {
          var o,
              a,
              s,
              l = 0,
          ...
          if (l += u, y && u !== l) {
            ...
            if (e) {
              if (0 < l) for (; u--;) {
                c[u] || d[u] || (d[u] = L.call(_r));
              }
              d = ve(d);
            }

            _.apply(_r, d), i && !e && 0 < d.length && 1 < l + v.length && re.uniqueSort(_r);
          }
      ...
      if (n = n || [], 1 === c.length) {
        ...
        for (i = J.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !x.relative[s = a.type]);) {
          if ((l = x.find[s]) && (r = l(a.matches[0].replace(te, ne), Z.test(o[0].type) && fe(t.parentNode) || t))) {
            if (o.splice(i, 1), !(e = r.length && he(o))) return _.apply(n, r), n;
            break;
          }
        }
      }

      return (u || d(e, c))(r, t, !y, n, Z.test(e) && fe(t.parentNode) || t), n;
  ...
  (C.fn.init = function (e, t) {
    ...
    if (n[1]) {
      if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : N, !0)), b.test(n[1]) && C.isPlainObject(t)) for (n in t) {
  ...
  C.Callbacks = function (i) {
    ...
    var r,
      ...
      add: function add() {
        if (u) {
          ...
          }(arguments), r ? a = u.length : t && (l = e, d(t));
        }
    ...
    when: function when(e) {
      ...
      if (1 < a) for (i = new Array(a), t = new Array(a), n = new Array(a); r < a; r++) {
    ...
    if (!D) if (D = C.Deferred(), "complete" === N.readyState) setTimeout(C.ready);else if (N.addEventListener) N.addEventListener("DOMContentLoaded", _, !1), h.addEventListener("load", _, !1);else {
  ...
  function R(e, t, n, r) {
    if (C.acceptData(e)) {
      var i,
          ...
          l = s ? C.cache : e,
          u = s ? e[a] : e[a] && a;
      if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = d.pop() || C.guid++ : a), l[u] || (l[u] = s ? {} : {
        toJSON: C.noop
      }), ("object" == _typeof(t) || "function" == typeof t) && (r ? l[u] = C.extend(l[u], t) : l[u].data = C.extend(l[u].data, t)), o = l[u], r || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[C.camelCase(t)] = n), "string" == typeof t ? null == (i = o[t]) && (i = o[C.camelCase(t)]) : i = o, i;
    }
  }
  ...
  var $ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    var s = 0,
        l = e.length,
        u = null == n;
    if ("object" === C.type(n)) for (s in i = !0, n) {
  ...
  C.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      if (g) {
        for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = C.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || ((c = g.handle = function (e) {
          return _typeof(C) === M || e && C.event.triggered === e.type ? void 0 : C.event.dispatch.apply(c.elem, arguments);
        }).elem = e), s = (t = (t || "").match(j) || [""]).length; s--;) {
          p = m = (o = Q.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), p && (u = C.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = C.event.special[p] || {}, d = C.extend({
            type: p,
            origType: m,
            data: r,
            handler: n,
      ...
      if (g && (c = g.events)) {
        for (u = (t = (t || "").match(j) || [""]).length; u--;) {
          if (p = m = (s = Q.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
            for (d = C.event.special[p] || {}, f = c[p = (r ? d.delegateType : d.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = f.length; o--;) {
    ...
    trigger: function trigger(e, t, n, r) {
      ...
      if (a = u = n = n || N, 3 !== n.nodeType && 8 !== n.nodeType && !G.test(f + C.event.triggered) && (0 <= f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), o = f.indexOf(":") < 0 && "on" + f, (e = e[C.expando] ? e : new C.Event(f, "object" == _typeof(e) && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), l = C.event.special[f] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
        ...
        for (c = 0; (a = d[c++]) && !e.isPropagationStopped();) {
          e.type = 1 < c ? s : l.bindType || f, (i = (C._data(a, "events") || {})[e.type] && C._data(a, "handle")) && i.apply(a, t), (i = o && a[o]) && i.apply && C.acceptData(a) && (e.result = i.apply(a, t), !1 === e.result && e.preventDefault());
        }
    ...
    handlers: function handlers(e, t) {
      ...
      if (s && l.nodeType && (!e.button || "click" !== e.type)) for (; l != this; l = l.parentNode || this) {
        if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
          for (i = [], o = 0; o < s; o++) {
            void 0 === i[n = (r = t[o]).selector + " "] && (i[n] = r.needsContext ? 0 <= C(n, this).index(l) : C.find(n, this, null, [l]).length), i[n] && i.push(r);
          }
    ...
    var r = "on" + t;
    e.detachEvent && (_typeof(e[r]) === M && (e[r] = null), e.detachEvent(r, n));
  }, C.Event = function (e, t) {
    return this instanceof C.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? K : Z) : this.type = e, t && C.extend(this, t), this.timeStamp = e && e.timeStamp || C.now(), void (this[C.expando] = !0)) : new C.Event(e, t);
  }, C.Event.prototype = {
    ...
    setup: function setup() {
      return V.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (C.event.add(this, "propertychange._change", function (e) {
  ...
  function ve(e, t) {
    var n,
        r,
        i = 0,
        o = _typeof(e.getElementsByTagName) !== M ? e.getElementsByTagName(t || "*") : _typeof(e.querySelectorAll) !== M ? e.querySelectorAll(t || "*") : void 0;
  ...
  function Ce(e, t) {
    if (1 === t.nodeType && C.hasData(e)) {
      ...
      if (s) for (n in delete a.handle, a.events = {}, s) {
  ...
  me.optgroup = me.option, me.tbody = me.tfoot = me.colgroup = me.caption = me.thead, me.th = me.td, C.extend({
    clone: function clone(e, t, n) {
      ...
      if (v.html5Clone || C.isXMLDoc(e) || !ie.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML, ge.removeChild(o = ge.firstChild)), !(v.noCloneEvent && v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (r = ve(o), s = ve(e), a = 0; null != (i = s[a]); ++a) {
        r[a] && Ne(i, r[a]);
      }
      if (t) if (n) for (s = s || ve(e), r = r || ve(o), a = 0; null != (i = s[a]); a++) {
        Ce(i, r[a]);
      } else Ce(e, o);
    ...
    buildFragment: function buildFragment(e, t, n, r) {
      for (var i, o, a, s, l, u, c, d = e.length, f = te(t), p = [], h = 0; h < d; h++) {
        if ((o = e[h]) || 0 === o) if ("object" === C.type(o)) C.merge(p, o.nodeType ? [o] : o);else if (ue.test(o)) {
          for (s = s || f.appendChild(t.createElement("div")), l = (se.exec(o) || ["", ""])[1].toLowerCase(), c = me[l] || me._default, s.innerHTML = c[1] + o.replace(ae, "<$1></$2>") + c[2], i = c[0]; i--;) {
            s = s.lastChild;
          }

          if (!v.leadingWhitespace && oe.test(o) && p.push(t.createTextNode(oe.exec(o)[0])), !v.tbody) for (i = (o = "table" !== l || le.test(o) ? "<table>" !== c[1] || le.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) {
      ...
      for (s && f.removeChild(s), v.appendChecked || C.grep(ve(p, "input"), ye), h = 0; o = p[h++];) {
        if ((!r || -1 === C.inArray(o, r)) && (a = C.contains(o.ownerDocument, o), s = ve(f.appendChild(o), "script"), a && Te(s), n)) for (i = 0; o = s[i++];) {
    ...
    cleanData: function cleanData(e, t) {
      for (var n, r, i, o, a = 0, s = C.expando, l = C.cache, u = v.deleteExpando, c = C.event.special; null != (n = e[a]); a++) {
        if ((t || C.acceptData(n)) && (o = (i = n[s]) && l[i])) {
          ...
          l[i] && (delete l[i], u ? delete n[s] : _typeof(n.removeAttribute) !== M ? n.removeAttribute(s) : n[s] = null, d.push(i));
        }
      }
    }
  }), C.fn.extend({
    ...
    domManip: function domManip(n, r) {
      n = m.apply([], n);
      var e,
          t,
          i,
          ...
          f = n[0],
          p = C.isFunction(f);
      if (p || 1 < u && "string" == typeof f && !v.checkClone && de.test(f)) return this.each(function (e) {
        var t = c.eq(e);
      ...
      if (u && (e = (s = C.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === s.childNodes.length && (s = e), e)) {
        for (i = (o = C.map(ve(s, "script"), xe)).length; l < u; l++) {
          t = s, l !== d && (t = C.clone(t, !0, !0), i && C.merge(o, ve(t, "script"))), r.call(this[l], t, l);
        }

        if (i) for (a = o[o.length - 1].ownerDocument, C.map(o, we), l = 0; l < i; l++) {
          t = o[l], fe.test(t.type || "") && !C._data(t, "globalEval") && C.contains(a, t) && (t.src ? C._evalUrl && C._evalUrl(t.src) : C.globalEval((t.text || t.textContent || t.innerHTML || "").replace(he, "")));
        }
        s = e = null;
      }
    ...
    C.fn[e] = function (e) {
      for (var t, n = 0, r = [], i = C(e), o = i.length - 1; n <= o; n++) {
        t = n === o ? this : this.clone(!0), C(i[n])[a](t), s.apply(r, t.get());
      }
  ...
  function De(e) {
    var t = N,
        n = Se[e];
    return n || ("none" !== (n = Ae(e, t)) && n || ((t = ((Ee = (Ee || C("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Ee[0].contentDocument).document).write(), t.close(), n = Ae(e, t), Ee.detach()), Se[e] = n), n;
  }
  ...
  h.getComputedStyle ? (je = function je(e) {
    ...
    var r,
        ...
        a,
        s = e.style;
    return a = (n = n || je(e)) ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || C.contains(e.ownerDocument, e) || (a = C.style(e, t)), _e.test(a) && He.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 === a ? a : a + "";
  }) : N.documentElement.currentStyle && (je = function je(e) {
  ...
  function Xe(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++) {
      (r = e[a]).style && (o[a] = C._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && I(r) && (o[a] = C._data(r, "olddisplay", De(r.nodeName)))) : (i = I(r), (n && "none" !== n || !i) && C._data(r, "olddisplay", i ? n : C.css(r, "display"))));
    }
  ...
  function Ve(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) {
      "margin" === n && (a += C.css(e, n + z[o], !0, i)), r ? ("content" === n && (a -= C.css(e, "padding" + z[o], !0, i)), "margin" !== n && (a -= C.css(e, "border" + z[o] + "Width", !0, i))) : (a += C.css(e, "padding" + z[o], !0, i), "padding" !== n && (a += C.css(e, "border" + z[o] + "Width", !0, i)));
    }
  ...
  C.extend({
    ...
    style: function style(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if ("string" === (o = _typeof(n)) && (i = Re.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(C.css(e, t)), o = "number"), null != n && n == n && ("number" !== o || C.cssNumber[s] || (n += "px"), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
          l[t] = n;
        } catch (e) {}
      }
    },
    css: function css(e, t, n, r) {
      var i,
          ...
          a,
          s = C.camelCase(t);
      return t = C.cssProps[s] || (C.cssProps[s] = Ie(e.style, s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Le(e, t, r)), "normal" === o && t in $e && (o = $e[t]), "" === n || n ? (i = parseFloat(o), !0 === n || C.isNumeric(i) ? i || 0 : o) : o;
    }
  }), C.each(["height", "width"], function (e, i) {
    C.cssHooks[i] = {
      get: function get(e, t, n) {
        return t ? Be.test(C.css(e, "display")) && 0 === e.offsetWidth ? C.swap(e, We, function () {
          return Je(e, i, n);
        }) : Je(e, i, n) : void 0;
      },
    ...
    run: function run(e) {
      ...
      return this.pos = t = this.options.duration ? C.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Ye.propHooks._default.set(this), this;
    }
  ...
  var Ge,
    ...
    for (r in n.queue || (null == (s = C._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, l = s.empty.fire, s.empty.fire = function () {
    ...
    })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = C.css(t, "display"), "inline" === ("none" === u ? C._data(t, "olddisplay") || De(t.nodeName) : u) && "none" === C.css(t, "float") && (v.inlineBlockNeedsLayout && "inline" !== De(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")), n.overflow && (f.overflow = "hidden", v.shrinkWrapBlocks() || c.always(function () {
      ...
      if (i = e[r], rt.exec(i)) {
        ...
        d[r] = h && h[r] || C.style(t, r);
      } else u = void 0;
    }

    if (C.isEmptyObject(d)) "inline" === ("none" === u ? De(t.nodeName) : u) && (f.display = u);else for (r in h ? "hidden" in h && (p = h.hidden) : h = C._data(t, "fxshow", {}), o && (h.hidden = !p), p ? C(t).show() : c.done(function () {
      C(t).hide();
    }), c.done(function () {
      var e;

      for (e in C._removeData(t, "fxshow"), d) {
        C.style(t, e, d[e]);
      }
    }), d) {
      a = ct(p ? h[r] : 0, r, c), r in h || (h[r] = a.start, p && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0));
    }
  }],
      st = {
    "*": [function (e, t) {
  ...
  function dt(o, e, t) {
    ...
    for (function (e, t) {
      ...
      for (n in e) {
        if (i = t[r = C.camelCase(n)], o = e[n], C.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = C.cssHooks[r]) && ("expand" in a)) for (n in o = a.expand(o), delete e[r], o) {
  ...
  C.fn.extend({
    val: function val(n) {
      ...
      })) : t ? (r = C.valHooks[t.type] || C.valHooks[t.nodeName.toLowerCase()]) && "get" in r && void 0 !== (e = r.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(ft, "") : null == e ? "" : e : void 0;
    }
  }), C.extend({
    valHooks: {
      option: {
  ...
  C.fn.extend({
    ...
    attr: function attr(e, t, n) {
      var r,
          i,
          o = e.nodeType;
      if (e && 3 !== o && 8 !== o && 2 !== o) return _typeof(e.getAttribute) === M ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (t = t.toLowerCase(), r = C.attrHooks[t] || (C.expr.match.bool.test(t) ? ht : pt)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void C.removeAttr(e, t));
    },
    removeAttr: function removeAttr(e, t) {
      ...
      if (o && 1 === e.nodeType) for (; n = o[i++];) {
        r = C.propFix[n] || n, C.expr.match.bool.test(n) ? yt && vt || !gt.test(n) ? e[r] = !1 : e[C.camelCase("default-" + n)] = e[r] = !1 : C.attr(e, n, ""), e.removeAttribute(vt ? n : r);
      }
    },
    attrHooks: {
      type: {
    ...
    set: function set(e, t, n) {
      return C.nodeName(e, "input") ? void (e.defaultValue = t) : pt && pt.set(e, t, n);
    }
  }), vt || (pt = {
    set: function set(e, t, n) {
  ...
  C.fn.extend({
    ...
    toggleClass: function toggleClass(i, t) {
      ...
      return "boolean" == typeof t && "string" === o ? t ? this.addClass(i) : this.removeClass(i) : this.each(C.isFunction(i) ? function (e) {
        ...
        if ("string" === o) for (var e, t = 0, n = C(this), r = i.match(j) || []; e = r[t++];) {
  ...
  function It(n, e, r, i) {
    ...
    if (C.isArray(e)) C.each(e, function (e, t) {
      r || Rt.test(n) ? i(n, t) : It(n + "[" + ("object" == _typeof(t) ? e : "") + "]", t, r, i);
    });else if (r || "object" !== C.type(e)) i(n, e);else for (t in e) {
      It(n + "[" + t + "]", e[t], r, i);
    }
  }
  ...
  h.ActiveXObject && C(h).on("unload", function () {
    ...
    if (!l.crossDomain || v.cors) return {
      send: function send(e, o) {
        var t,
            a = l.xhr(),
            s = ++Xt;
        if (a.open(l.type, l.url, l.async, l.username, l.password), l.xhrFields) for (t in l.xhrFields) {
          a[t] = l.xhrFields[t];
        }
        ...
        a.send(l.hasContent && l.data || null), _u = function u(e, t) {
          var n, r, i;
          if (_u && (t || 4 === a.readyState)) if (delete Ut[s], _u = void 0, a.onreadystatechange = C.noop, t) 4 !== a.readyState && a.abort();else {
        ...
        }, l.async ? 4 === a.readyState ? setTimeout(_u) : a.onreadystatechange = Ut[s] = _u : _u();
      },
  ...
  C.ajaxSetup({
    ...
    return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = C.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Gt, "$1" + r) : !1 !== e.jsonp && (e.url += (Ct.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
      return o || C.error(r + " was not called"), o[0];
    }, e.dataTypes[0] = "json", i = h[r], h[r] = function () {
      o = arguments;
    }, n.always(function () {
      h[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, Yt.push(r)), o && C.isFunction(i) && i(o[0]), o = i = void 0;
    }), "script") : void 0;
  ...
  C.fn.load = function (e, t, n) {
    ...
    var r,
        ...
        a = this,
        s = e.indexOf(" ");
    return 0 <= s && (r = C.trim(e.slice(s, e.length)), e = e.slice(0, s)), C.isFunction(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (o = "POST"), 0 < a.length && C.ajax({
      url: e,
      type: o,
      dataType: "html",
      data: t
  ...
  C.offset = {
    ...
    offset: function offset(t) {
      ...
      var e,
        ...
        left: 0
          ...
          i = this[0],
          o = i && i.ownerDocument;
      return o ? (e = o.documentElement, C.contains(e, i) ? (_typeof(i.getBoundingClientRect) !== M && (r = i.getBoundingClientRect()), n = Zt(o), {
    ...
    C.cssHooks[n] = Me(v.pixelPosition, function (e, t) {
      return t ? (t = Le(e, n), _e.test(t) ? C(e).position()[n] + "px" : t) : void 0;
    });
  }), C.each({
    Height: "height",
    Width: "width"
